...
export const NavLinks = () => {
  ...
  return (
    <nav className="bg-white/5 backdrop-blur-sm rounded-full z-3000">
      <NavigationMenu className="h-full w-full px-1 py-0.5 rounded-full border font-sans hidden md:block">
        <NavigationMenuList>
          {links.map((link) => {
            const isActive =
            ...
            return (
              <NavigationMenuItem key={link.name}>
                ...
                >
                  <NavigationMenuLink
                    href={link.id}
                    className="relative text-shadow-white rounded-full font-normal text-sm capitalize text-accent-foreground/70 hover:text-accent-foreground/90"
                  >
                    {link.name}
                    {isActive && (
                      <>
          ...
          <NavigationMenuItem>
            <NavigationMenuTrigger className="rounded-full text-shadow font-medium capitalize text-muted-foreground cursor-pointer hover:bg-transparent bg-transparent hover:text-accent-foreground/90">
              more
            </NavigationMenuTrigger>
            <NavigationMenuContent>
